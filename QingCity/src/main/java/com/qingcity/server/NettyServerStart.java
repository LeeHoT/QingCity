...
import com.qingcity.utils.NetUtil;
...
public class NettyServerStart {
	...
	private static void run() throws Exception {
		...
		factory = new FileSystemXmlApplicationContext("src/main/resources/config/applicationContext.xml");
		...
		server.run();
		logger.info("server is runninig!!");
	}
}