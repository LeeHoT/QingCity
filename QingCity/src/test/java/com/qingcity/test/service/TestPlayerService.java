...
public class TestPlayerService {
	...
	@Test
	public void testGetSocietyInfo() {
		PlayerEntity player = playerService.getPlayerSocietyInfo(39);
		System.out.println(playerService);
		System.out.println(playerService.getPlayerSocietyInfo(39).getSocietyId());
		System.out.println(player.getSocietyId());
	}
